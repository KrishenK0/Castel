...
public class FactionChestContainers extends Container {
    private final PlayerEntity playerEntity;
    private final IItemHandler playerInventory;

    public FactionChestContainers(int windowId, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        super(CastelContainers.FACTION_CHEST_CONTAINER.get(), windowId);
