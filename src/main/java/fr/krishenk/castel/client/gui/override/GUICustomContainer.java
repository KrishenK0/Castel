package fr.krishenk.castel.client.gui.override;
...
public abstract class GUICustomContainer extends GuiScreen {
	protected static final ResourceLocation bg = new ResourceLocation(Castel.MODID, "textures/gui/inventory.png");
	...
	public GUICustomContainer(Container container) {
		this.inventorySlots = container;
		this.field_146995_H = true;
	}
	/*
	 * protected void drawGuiContainerForegroundLayer(int p_146979_1_, int
	 * p_146979_2_) { String s = inventory.hasCustomInventoryName() ?
	 * inventory.getInventoryName() : I18n.format(inventory.getInventoryName());
	 * 
	 * fontRendererObj.drawString(s, xSize - fontRendererObj.getStringWidth(s), 12,
	 * 4210752); fontRendererObj.drawString(I18n.format("container.inventory"), 80,
	 * ySize - 96, 4210752);
	 * 
	 * }
	 * 
	 * protected void drawGuiContainerBackgroundLayer(float f, int i, int y) {
	 * GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
	 * mc.getTextureManager().bindTexture(bg); drawTexturedModalRect(guiLeft,
	 * guiTop, 0, 0, xSize, ySize); GuiInventory.func_147046_a(guiLeft + 51, guiTop
	 * + 75, 30, guiLeft + 51 - xSize_lo, guiTop + 25 - ySize_lo, mc.thePlayer); }
	 */
	...
	/*
	 * public void initGui() { super.initGui(); this.mc.thePlayer.openContainer =
	 * this.inventorySlots; this.guiLeft = (this.width - this.xSize) / 2;
	 * this.guiTop = (this.height - this.ySize) / 2;
	 * 
	 * buttonList.clear(); for (int i = 0; i < TABS.size(); i++) {
	 * buttonList.add(new GUICustomButton(i, (guiLeft + xSize), guiTop + 5 * i,
	 * "").bindTexture(bg, 256, 256) .setButtonDim(176, 0, 18, 18)); } }
	 */
	...
	public void drawScreen(int mouseX, int mouseY, float ticks) {
		int k = this.guiLeft;
		int l = this.guiTop;
		this.drawGuiContainerBackgroundLayer(ticks, mouseX, mouseY);
	...
	private void drawItemStack(ItemStack p_146982_1_, int p_146982_2_, int p_146982_3_, String p_146982_4_) {
		...
		itemRender.renderItemOverlayIntoGUI(font, this.mc.getTextureManager(), p_146982_1_, p_146982_2_,
				p_146982_3_ - (this.draggedStack == null ? 0 : 8), p_146982_4_);
		this.zLevel = 0.0F;
	...
	private void func_146977_a(Slot p_146977_1_) {
		...
		if (p_146977_1_ == this.clickedSlot && this.draggedStack != null && this.isRightMouseClick
				&& itemstack != null) {
			itemstack = itemstack.copy();
			...
			if (Container.func_94527_a(p_146977_1_, itemstack1, true)
					&& this.inventorySlots.canDragIntoSlot(p_146977_1_)) {
				itemstack = itemstack1.copy();
				flag = true;
				Container.func_94525_a(this.field_147008_s, this.field_146987_F, itemstack,
	...
	private void func_146980_g() {
		...
		if (itemstack != null && this.field_147007_t) {
			...
			for (Iterator iterator = this.field_147008_s.iterator(); iterator
					.hasNext(); this.field_146996_I -= itemstack1.stackSize - i) {
	...
	protected void mouseClicked(int p_73864_1_, int p_73864_2_, int p_73864_3_) {
		...
		if (p_73864_3_ == 0 || p_73864_3_ == 1 || flag) {
			int i1 = this.guiLeft;
			int j1 = this.guiTop;
			boolean flag1 = p_73864_1_ < i1 || p_73864_2_ < j1 || p_73864_1_ >= i1 + this.xSize
					|| p_73864_2_ >= j1 + this.ySize;
			int k1 = -1;
	...
	protected void mouseClickMove(int p_146273_1_, int p_146273_2_, int p_146273_3_, long p_146273_4_) {
		...
		if (this.clickedSlot != null && this.mc.gameSettings.touchscreen) {
			if (p_146273_3_ == 0 || p_146273_3_ == 1) {
				...
				&& itemstack.stackSize > this.field_147008_s.size() && Container.func_94527_a(slot, itemstack, true)
	...
	protected void mouseMovedOrUp(int p_146286_1_, int p_146286_2_, int p_146286_3_) {
		...
		int l = this.guiLeft;
		int i1 = this.guiTop;
		boolean flag = p_146286_1_ < l || p_146286_2_ < i1 || p_146286_1_ >= l + this.xSize
				|| p_146286_2_ >= i1 + this.ySize;
		int j1 = -1;
		...
		if (this.field_146993_M && slot != null && p_146286_3_ == 0
			...
			if (isShiftKeyDown()) {
				if (slot != null && slot.inventory != null && this.field_146994_N != null) {
					...
					while (iterator.hasNext()) {
						...
						if (slot1 != null && slot1.canTakeStack(this.mc.thePlayer) && slot1.getHasStack()
