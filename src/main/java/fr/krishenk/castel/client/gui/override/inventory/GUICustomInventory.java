package fr.krishenk.castel.client.gui.override.inventory;
...
public class GUICustomInventory extends CustomInventoryRenderer {
	...
	private static NewInventory inventory;

	public GUICustomInventory(EntityPlayer player, InventoryPlayer inventoryPlayer, NewInventory newInventory) {
		super(new ContainerCustom(player, inventoryPlayer, newInventory));
	...
	public void initGui() {
		if (this.mc.playerController.isInCreativeMode()) {
			...
			for (int i = 0; i < TABS.size(); i++) {
				this.buttonList.add(new GUICustomButton(i, (guiLeft + xSize) + 2 + i, guiTop + 12 + i, "")
	...
	public void drawScreen(int mouseX, int mouseY, float ticks) {
		...
		func_152125_a(guiLeft + xSize, guiTop + 5, 120, 166, 26, 32, 26, 32, 256, 256);
	...
	private static void initTabs() {
		...
		TABS.add(new TabGui() {
			public Class<? extends GuiScreen> getClassReferent() {
				return (Class) GUICustomContainer.class;
			}
...
//		}
	...
	protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_) {
		...
		this.fontRendererObj.drawString(I18n.format(this.inventory.getInventoryName(), new Object[0]), 90, 70, 4210752);
	}
	...
	protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
		...
		func_147046_a(k + 51, l + 75, 30, (float) (k + 51) - this.xSizeFloat, (float) (l + 75 - 50) - this.ySizeFloat,
				this.mc.thePlayer);
	}
